    ...
    <div className="w-full ">
      ...
      <div className="container mx-auto  ">
        <p className="text-white font-poppins font-thin my-10 text-[17px] text-center">
          ...
          island has an individual age rating so you can find the one
      ...
      <div className="container mx-auto flex items-center justify-center mt-48 gap-10">
        <div className="flex flex-col gap-10 w-[347px] h-[500px] ">
          <div className="w-[347px] h-[347px] object-cover overflow-hidden">
            <img src={GameImage} alt="game" />
          </div>
          <p className="text-secondary font-roboto font-thin text-[21px]  text-center justify-center">
      ...
      <div className="container mx-auto flex flex-col gap-5 mt-40">
        <h3 className="text-secondary font-roboto text-center font-extralight text-4xl">
          Our Contribution
        </h3>
      ...
      <div className="container mx-auto ">
        <div className=" flex flex-col gap-8 items-center justify-center mt-40">
          <h2 className="font-roboto text-secondary font-light text-5xl text-center">
          ...
          <p className="font-roboto text-secondary text-4xl font-extralight text-center ">
            ...
            can reach out to us via email at{" "}
            <span className="font-normal">hello@abc.com</span> or give us a call
            at <span className="font-normal">+91 480 20802730</span>
          </p>
        </div>
        <div className="flex items-center justify-center gap-10 mt-16">
          <p className="text-secondary font-poppins text-[18px] text-center border-[1px] p-2 w-72 ">
            Ring us on Skype
          </p>
          <p className="text-primary font-poppins text-[18px] text-center p-2 w-72 bg-secondary">
            Contact Us
          </p>
        </div>
      </div>
      <div className="container mx-auto mt-40">
        <p className="font-roboto font-thin text-xl text-secondary text-center">
